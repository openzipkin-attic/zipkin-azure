...
public class DummyEventProcessorHost implements IEventProcessorHost {

  public boolean unrergisterWasCalled = false;
  public boolean rergisterWasCalled = false;

  @Override
  public Future<?> registerEventProcessorFactory(IEventProcessorFactory<?> factory) throws Exception {
    rergisterWasCalled = true;
    return null;
  }

  @Override
  public void unregisterEventProcessor() throws InterruptedException, ExecutionException {
    unrergisterWasCalled = true;
  }
}
