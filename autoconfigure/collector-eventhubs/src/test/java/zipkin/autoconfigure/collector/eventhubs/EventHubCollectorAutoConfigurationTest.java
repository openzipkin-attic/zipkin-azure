...
import zipkin.collector.eventhubs.EventHubCollector;
...
public class EventHubCollectorAutoConfigurationTest {
    ...
    public void provideCollectorComponent_whenEventHubConnectionStringIsSet() {
        context = new AnnotationConfigApplicationContext();
        addEnvironment(context, "zipkin.collector.eventhubs.storageConnectionString:" + dummyStorageConnectionString);
        addEnvironment(context, "zipkin.collector.eventhubs.eventHubConnectionString:" + dummyEventHubConnectionString );
        context.register(PropertyPlaceholderAutoConfiguration.class,
                EventHubCollectorAutoConfiguration.class,
                InMemoryConfiguration.class);
        context.refresh();
    ...
    public void provideCollectorComponent_canSetConsumerGroupName() {
        ...
        context = new AnnotationConfigApplicationContext();
        addEnvironment(context, "zipkin.collector.eventhubs.storageConnectionString:" + dummyEventHubConnectionString);
        addEnvironment(context, "zipkin.collector.eventhubs.eventHubConnectionString:" + dummyStorageConnectionString );
        addEnvironment(context, "zipkin.collector.eventhubs.consumerGroupName:" + consumerGroupName);
        context.register(PropertyPlaceholderAutoConfiguration.class,
                EventHubCollectorAutoConfiguration.class,
                InMemoryConfiguration.class);
        context.refresh();
    ...
    public void provideCollectorComponent_canSetEventHubName() {
        ...
        addEnvironment(context, "zipkin.collector.eventhubs.storageConnectionString:" + dummyEventHubConnectionString);
        addEnvironment(context, "zipkin.collector.eventhubs.eventHubConnectionString:" + dummyStorageConnectionString );
        addEnvironment(context, "zipkin.collector.eventhubs.eventHubName:" + eventHubName);
        context.register(PropertyPlaceholderAutoConfiguration.class,
                EventHubCollectorAutoConfiguration.class,
                InMemoryConfiguration.class);
        context.refresh();
    ...
    public void provideCollectorComponent_canSetProcessorHostName() {
        ...
        addEnvironment(context, "zipkin.collector.eventhubs.storageConnectionString:" + dummyEventHubConnectionString);
        addEnvironment(context, "zipkin.collector.eventhubs.eventHubConnectionString:" + dummyStorageConnectionString );
        addEnvironment(context, "zipkin.collector.eventhubs.processorHostName:" + processorHostName);
        context.register(PropertyPlaceholderAutoConfiguration.class,
                EventHubCollectorAutoConfiguration.class,
                InMemoryConfiguration.class);
        context.refresh();
    ...
    public void provideCollectorComponent_canSetStorageBlobPrefix() {
        ...
        addEnvironment(context, "zipkin.collector.eventhubs.storageConnectionString:" + dummyEventHubConnectionString);
        addEnvironment(context, "zipkin.collector.eventhubs.eventHubConnectionString:" + dummyStorageConnectionString );
        addEnvironment(context, "zipkin.collector.eventhubs.storageBlobPrefix:" + storageBlobPrefix);
        context.register(PropertyPlaceholderAutoConfiguration.class,
                EventHubCollectorAutoConfiguration.class,
                InMemoryConfiguration.class);
        context.refresh();
    ...
    public void provideCollectorComponent_canSetStorageContainerName() {
        ...
        addEnvironment(context, "zipkin.collector.eventhubs.storageConnectionString:" + dummyEventHubConnectionString);
        addEnvironment(context, "zipkin.collector.eventhubs.eventHubConnectionString:" + dummyStorageConnectionString );
        addEnvironment(context, "zipkin.collector.eventhubs.storageContainerName:" + storageContainerName);
        context.register(PropertyPlaceholderAutoConfiguration.class,
                EventHubCollectorAutoConfiguration.class,
                InMemoryConfiguration.class);
        context.refresh();
    ...
    public void provideCollectorComponent_canSetCheckpointBatchSize() {
        ...
        addEnvironment(context, "zipkin.collector.eventhubs.storageConnectionString:" + dummyEventHubConnectionString);
        addEnvironment(context, "zipkin.collector.eventhubs.eventHubConnectionString:" + dummyStorageConnectionString );
        addEnvironment(context, "zipkin.collector.eventhubs.checkpoint-batch-size:" + checkpointBatchSize);
        context.register(PropertyPlaceholderAutoConfiguration.class,
                EventHubCollectorAutoConfiguration.class,
                InMemoryConfiguration.class);
        context.refresh();
